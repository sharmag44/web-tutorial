...
export default function ES6() {
  return (
    <div className="ES6">
      ...
      <MainText
        lg="ES6 or ECMAScript 2015 is the 6th version of the ECMAScript programming language. ECMAScript is the standardization of Javascript which was released in 2015, and subsequently renamed as ECMAScript 2015.
ECMAScript and Javascript are both different in nature."
      />
      <h3>React ES6 Classes</h3>
      <h4>Classes</h4>
      <MainText lg="A class is a type of function, but instead of using the keyword function to initiate it, we use the keyword class, and the properties are assigned inside a constructor() method." />
      <h5>Example</h5>
      ...
      <MainText
        lg="To create a class inheritance, use the extends keyword.
